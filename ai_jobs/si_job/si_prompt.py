"""
ai_jobs/si_job/si_prompt.py  —  Prompt assembly, AI dispatch, chunking,
...
You will receive:
  ...
  2. SINHALA REFERENCE       — the authentic published Sinhala Tipiṭaka text (ePiṭaka) for the same section,
                               together with its Pāli source. Use this as the secondary guide for meaning (after aṭṭhakathā, ṭīkā),
  ...
  5. PĀLI COMMENTARY & SUB-COMMENTARY — Aṭṭhakathā and Tīkā texts linked to the sentences being
                               ...
                               Take the idea mentioned here as primary decision if the translation in Sinhala doesn't match.
